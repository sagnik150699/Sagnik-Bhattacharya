...
@{Slug='keyboard-shortcuts';P='#1F2937';S='#10B981';Hook='Find Windows, Mac, Web, and function key shortcuts without guessing.';CTA='Use The 200+ Reference';K=@('Windows','Mac','200+');Cue='category panels and a 200+ reference grid';CoverTag='Excel Reference';CoverTitle='200+ Excel Keyboard Shortcuts'},
