...
NEW_POSTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "related_new": ["run-gemma-4-own-machine", "local-ai-own-files", "choose-open-models-vs-api-models"],
    ...
    },
    {
        ...
        "related_new": ["run-gemma-4-own-machine", "build-rag-app-own-documents", "gemma-4-local-ai-workflows"],
    ...
    },
    {
        ...
        "related_new": ["run-gemma-4-own-machine", "cut-ai-api-costs-caching-routing", "gemma-4-local-ai-workflows"],
